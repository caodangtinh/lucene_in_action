package com.tinhcao.analysis.synonym;
...
/*
 * #1 Define synonym buffer #2 Pop buffered synonyms #3 Set position increment
 * to 0 #4 Read next token #5 Push synonyms onto stack #6 Save current token #7
 * Return current token #8 Retrieve synonyms #9 Push synonyms onto stack
 */
